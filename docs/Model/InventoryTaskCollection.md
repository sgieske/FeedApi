...
**tasks** | [**\OpenAPI\Client\Model\InventoryTask[]**](InventoryTask.md) | An array of the inventory tasks on this page. The tasks are sorted by creation date. Note: An empty array is returned if the filter criteria excludes all tasks. | [optional]
