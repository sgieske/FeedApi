...
class InventoryTaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets offset
     *
     * @param int|null $offset The number of results skipped in the result set before listing the first returned result. This value can be specified in the request with the offset query parameter. Note: The items in a paginated result set use a zero-based list, where the first item in the list has an offset of 0.
     *
     * @return self
     */
     ...
     * Sets tasks
     *
     * @param \OpenAPI\Client\Model\InventoryTask[]|null $tasks An array of the inventory tasks on this page. The tasks are sorted by creation date. Note: An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
