 ...
 *
 * @category Class
 * @description The type that defines the fields for a paginated result set of tasks. The response consists of 0 or more sequenced pages where each page has 0 or more items.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class TaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'tasks' => '\OpenAPI\Client\Model\Task[]',
        'total' => 'int'
    ];
     ...
     * Gets tasks
     *
     * @return \OpenAPI\Client\Model\Task[]|null
     */
     ...
     * Sets tasks
     *
     * @param \OpenAPI\Client\Model\Task[]|null $tasks An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
