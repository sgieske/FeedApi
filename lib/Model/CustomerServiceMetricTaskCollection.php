 ...
 */
class CustomerServiceMetricTaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerServiceMetricTaskCollection';
     ...
     * Sets href
     *
     * @param string|null $href The URI of the current page of results.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next The relative path to the call URI for the next page of results. This value is returned if there is an additional page of results to return from the result set.
     *
     * @return self
     */
     ...
     * Sets offset
     *
     * @param int|null $offset The number of results skipped in the result set before returning the first result. This value can be set in the request with the offset query parameter. Note: The items in a paginated result set use a zero-based list where the first item in the list has an offset of 0.
     *
     * @return self
     */
     ...
     * Sets prev
     *
     * @param string|null $prev The URI for the previous page of results. This parameter is returned if a previous page of results from the result set exists.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of tasks that match the criteria.
     *
     * @return self
     */
