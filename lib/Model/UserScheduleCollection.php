 ...
 *
 * @category Class
 * @description The type that defines the fields for a paginated result set of user schedules. The response consists of 0 or more sequenced pages where each page has 0 or more items.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UserScheduleCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserScheduleCollection';
     ...
     * Sets total
     *
     * @param int|null $total The total number of schedules that match the input criteria.
     *
     * @return self
     */
