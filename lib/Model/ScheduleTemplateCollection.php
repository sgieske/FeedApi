 ...
 *
 * @category Class
 * @description The type that defines the fields for a paginated result set of schedule templates. The response consists of 0 or more sequenced pages where each page has 0 or more items.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ScheduleTemplateCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleTemplateCollection';
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'schedule_templates' => '\OpenAPI\Client\Model\ScheduleTemplateResponse[]',
        'total' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['schedule_templates'] = $data['schedule_templates'] ?? null;
     ...
     *
     * @return \OpenAPI\Client\Model\ScheduleTemplateResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ScheduleTemplateResponse[]|null $schedule_templates An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of schedule templates that match the input criteria.
     *
     * @return self
     */
